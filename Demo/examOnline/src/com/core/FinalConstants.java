...
public final class FinalConstants {
	...
	public static final int PAPER_FINALS = 0;
	public static final int PAPER_REFINALS = 1;
	public static final int USER_PASS = 0;
	public static final int USER_REPASS = 1;
	// user
