    ...
    <table width="1023" height="450" border="0" align="center">
        ...
        <tr>
            <td height="65" valign="top">
                <label>
                    <br/>
                    <input type="submit" name="Submit" value="登陆" onClick="return login()" class="STYLE1"/>
                    &nbsp;
                </label>
                <label>
                    <input type="reset" name="Submit2" value="取消" class="STYLE1"/>
                </label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <div align="center">
                    ...
                    <hr/>
                    <span class="zimui12" style="text-align: left"><span class="ziti16"><span
                            class="tiyanshehui STYLE4">版权所有:Copyright 2014 南京工程学院 通信工程学院</span> </span> </span><span
                        class="ziti16 STYLE4 STYLE6" style="text-align: left"></span>
                </div>
            </td>
        </tr>
    </table>
